...
RESULTS_DIR = "/home/zkytony/Documents/thesis/experiments/spn_topo/experiments/results"#"/home/kaiyu/Documents/Projects/Research/SaraRobotics/repo/spn_topo/experiments/results/"
...
def get_stats(exp_name, test_name, db_name):
    ...
    overall_stats = {}
    overall_accs = {}
    for fname in glob.glob(os.path.join(RESULTS_DIR, exp_name, 'results', 'overall_%s*.log' % test_name)):
...
if __name__ == "__main__":
    ...
    try:
        ...
        for i in range(args.num_runs):
            ...
            proc = subprocess.Popen(['./test_instance_spn.py',
        ...
        save_path = os.path.join(RESULTS_DIR, args.exp_name, 'results', 'collected_overall_%s_%s_%s.log' % (test_name, time.strftime("%Y%m%d-%H%M"), db_name))
