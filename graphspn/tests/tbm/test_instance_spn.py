...
def run_nodetemplate_experiment(seed, train_kwargs, test_kwargs, to_do, amount=1, num_rounds=3, name=None, seq_id=None):
    """
    Arguments:
...
if __name__ == "__main__":
    ...
    run_nodetemplate_experiment(args.seed, train_kwargs, test_kwargs, to_do,
